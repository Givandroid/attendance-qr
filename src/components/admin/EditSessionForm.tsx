...
import { ChevronDownIcon, MapPin, Save, CalendarCheck, Type, FileEdit, AlertCircle } from 'lucide-react'
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-in fade-in duration-200">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl max-w-lg w-full p-6 animate-in zoom-in-95 duration-200 max-h-[90vh] overflow-y-auto">
        {/* Icon */}
        <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 bg-orange-100">
        ...
        <div className="flex gap-3">
          ...
          <Button
            ...
            className="flex-1 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300 text-white bg-orange-600 hover:bg-orange-700"
          >
            {confirmText}
          </Button>
        </div>
  ...
  return (
    <>
      ...
      <ConfirmModal
        ...
        message="Pastikan semua perubahan informasi sesi sudah benar. Perubahan akan langsung disimpan."
